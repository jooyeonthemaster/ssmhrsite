  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-brand-navy pt-20">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-blue-600/20 rounded-full blur-[120px] mix-blend-screen animate-pulse" />
        <div className="absolute bottom-0 right-0 w-[600px] h-[600px] bg-brand-gold/10 rounded-full blur-[120px] mix-blend-screen" />
      ...
      <Container className="relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <Button 
              size="lg" 
              className="h-14 px-8 text-lg bg-white text-brand-navy hover:bg-blue-50 rounded-full font-semibold transition-all hover:scale-105"
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="h-14 px-8 text-lg border-white/20 text-white hover:bg-white/10 hover:border-white rounded-full transition-all bg-transparent group"
